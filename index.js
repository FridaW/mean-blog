...
const email = require('./routes/email')(router); // Import Email Routes
...
mongoose.connect(config.uri, {
  ...
  if (err) {
    ...
    console.log('Connected to ' + config.url + ' database ' + config.db); // Return success message
  }
});
...
app.use('/email', email); // Use Email routes in application
